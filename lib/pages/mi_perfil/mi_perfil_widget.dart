  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final miPerfilUsersRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
          appBar: AppBar(
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    16.0, 0.0, 0.0, 0.0),
                                child: Text(
                                  miPerfilUsersRecord.displayName,
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      ...
                                      extra: <String, dynamic>{
                                        'displayName': miPerfilUsersRecord,
                                        'email': miPerfilUsersRecord,
                                      },
                                    );
                                  },
                                  child: Row(
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed('CambiarContrasenia');
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.center,
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      context.goNamedAuth(
                                          'SplashPantalla', context.mounted);
                                    },
                                    text: 'Cerrar sesión',

...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const NavBarPage() : const SplashPantallaWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'SplashPantalla',
          path: '/splashPantalla',
          builder: (context, params) => const SplashPantallaWidget(),
        ),
        FFRoute(
          name: 'Acceder',
          path: '/acceder',
          builder: (context, params) => const AccederWidget(),
        ),
        FFRoute(
          name: 'Inicio',
          path: '/inicio',
        ...
        FFRoute(
          ...
          builder: (context, params) => const CambiarContraseniaWidget(),
        ),
        FFRoute(
          name: 'Tareas',
          path: '/tareas',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Tareas')
              : const TareasWidget(),
        )
